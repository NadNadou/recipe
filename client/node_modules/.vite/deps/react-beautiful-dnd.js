...
function useStyleMarshal(contextId, nonce) {
  ...
  var alwaysRef = (0, import_react2.useRef)(null);
  var dynamicRef = (0, import_react2.useRef)(null);
...
function useFocusMarshal(contextId) {
  var entriesRef = (0, import_react2.useRef)({});
  var recordRef = (0, import_react2.useRef)(null);
  var restoreFocusFrameRef = (0, import_react2.useRef)(null);
...
function usePrevious(current) {
  var ref2 = (0, import_react2.useRef)(current);
  (0, import_react2.useEffect)(function() {
...
function useMouseSensor(api) {
  var phaseRef = (0, import_react2.useRef)(idle$1);
  var unbindEventsRef = (0, import_react2.useRef)(noop);
...
function useKeyboardSensor(api) {
  var unbindEventsRef = (0, import_react2.useRef)(noop$1);
  var startCaptureBinding = useMemo(function() {
    return {
      eventName: "keydown",
...
function useTouchSensor(api) {
  var phaseRef = (0, import_react2.useRef)(idle$2);
  var unbindEventsRef = (0, import_react2.useRef)(noop);
...
function useSensorMarshal(_ref4) {
  ...
  var lockAPI = (0, import_react2.useState)(function() {
    return create();
  })[0];
...
function App(props) {
  ...
  var lazyStoreRef = (0, import_react2.useRef)(null);
...
function DragDropContext(props) {
  ...
  return import_react2.default.createElement(ErrorBoundary, null, function(setCallbacks) {
...
function useRequiredContext(Context) {
  var result = (0, import_react2.useContext)(Context);
...
function useDroppablePublisher(args) {
  var whileDraggingRef = (0, import_react2.useRef)(null);
  ...
  var publishedDescriptorRef = (0, import_react2.useRef)(descriptor);
...
function Placeholder(props) {
  var animateOpenTimerRef = (0, import_react2.useRef)(null);
  ...
  var _useState = (0, import_react2.useState)(props.animate === "open"), isAnimatingOpenOnMount = _useState[0], setIsAnimatingOpenOnMount = _useState[1];
  (0, import_react2.useEffect)(function() {
    if (!isAnimatingOpenOnMount) {
      return noop$2;
    }
...
function useDraggablePublisher(args) {
  ...
  var publishedRef = (0, import_react2.useRef)(entry);
  var isFirstPublishRef = (0, import_react2.useRef)(true);
  useIsomorphicLayoutEffect(function() {
...
function useClonePropValidation(isClone) {
  useDev(function() {
    var initialRef = (0, import_react2.useRef)(isClone);
    useDevSetupWarning(function() {
...
function Droppable(props) {
  var appContext = (0, import_react2.useContext)(AppContext);
  ...
  var droppableRef = (0, import_react2.useRef)(null);
  ...
  var placeholder2 = import_react2.default.createElement(AnimateInOut, {
  ...
  function getClone() {
    ...
    var node = import_react2.default.createElement(PrivateDraggable, {
